...
import cv2
import os
from diffusion_policy.real_world.fk.constants import PAXINI_PULP_COORD, PAXINI_TIP_COORD, PAXINI_THUMB_PULP_COORD, PAXINI_THUMB_TIP_COORD
...
def draw_axes(image, arm_joint_state, hand_joint_state, robot_kdl, intrinsics, cam2base, image_name, target_path='data/camera_1_color_image_with_axes', axis_length = 0.03):
