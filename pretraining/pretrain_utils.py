...
def build_args():
    ...
    parser.add_argument("--mask_index", type=int, default=9)
    ...
    parser.add_argument("--val_ratio", type=float, default=0.0, help="val data ratio")
...
class TBLogger(object):
    def __init__(self, log_path="./pretraining/logging_data", name="run"):
